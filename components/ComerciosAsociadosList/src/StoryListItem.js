                ...
                <View style={styles.userContainer}>
                    <View style={{flexDirection: 'row', alignItems: 'center', maxWidth: '80%'}}>
                        <Image style={styles.avatarImage}
                               source={{uri: EXPO_PUBLIC_API_URL + props.logo}}
                        />
                        <View>
                    ...
                    <TouchableOpacity onPress={() => {
                        ...
                        <View style={styles.closeIconContainer}>
                            {props.customCloseComponent ?
                                props.customCloseComponent : <Image source={icons.close} style={{width: 15, height: 15, resizeMode: 'contain', tintColor: '#fff'}}/>
                            }
                        </View>
                    </TouchableOpacity>
                </View>
